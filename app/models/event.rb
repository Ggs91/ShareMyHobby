class Event < ApplicationRecord
  ...
  validates :start_date, presence: {:message => ": Please select a date and time for your event" }
...
private
  ...
  def start_date_cannot_be_in_the_past
     errors.add(:start_date, "can't be in the past") unless start_date.present? && start_date >= DateTime.now
  end
